...
- The latest published Marketplace version is `0.1.3`.
- The next release version has not been selected; do not change the manifest version, package, or publish it without explicit maintainer approval.
